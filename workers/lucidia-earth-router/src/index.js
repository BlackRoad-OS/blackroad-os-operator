 ...
 * Routes lucidia.earth traffic to the Lucidia landing page
 * @owner Alexa Louise Amundson
 * @system BlackRoad OS
 */

const PAGES_ORIGIN = 'https://blackroad-os-web.pages.dev';
const CONTENT_PATH = '/lucidia-earth/';
  ...
  async fetch(request, env) {
    ...
    if (path === '/api' || path === '/api/') {
      return new Response(JSON.stringify({
        ...
        headers: { 'Content-Type': 'application/json', 'X-Served-By': 'lucidia-earth-router' }
      });
    }
    ...
    try {
      ...
      return new Response(JSON.stringify({ error: 'Service unavailable', domain: 'lucidia.earth' }), {
